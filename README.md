...
1. Download **`SelfCmd_Setup_2.0.1.exe`** from the link https://github.com/Rocky-Works/selfcmd-releases/releases/download/V2.0.1/SelfCmd_Setup_2.0.1.exe.
...
1. 从https://github.com/Rocky-Works/selfcmd-releases/releases/download/V2.0.1/SelfCmd_Setup_2.0.1.exe 下载 **`SelfCmd_Setup_2.0.1.exe`**。
2. 运行安装程序并按提示完成。
3. 从开始菜单启动 **SelfCmd**。
